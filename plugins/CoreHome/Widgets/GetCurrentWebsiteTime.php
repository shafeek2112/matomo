 ...
 */
class GetCurrentWebsiteTime extends Widget
{
    public static function getName()
    {
        return 'CoreHome_CurrentWebsiteTime';
    }
    ...
    public function render()
    {
        ...
        $timeZone = !empty($site->getTimezone()) ? $site->getTimezone() : null;


        return $this->renderTemplate('getCurrentWebsiteLocalTime.twig',array(
            'timeZone' => $timeZone,
        ));
    }
